class X2Ability_GrenadierAbilitySet_AyyLmao extends X2Ability_GrenadierAbilitySet;

static function X2AbilityTemplate HailOfBullets()
{
	local X2AbilityTemplate Template;
	
	Template = Super.HailOfBullets();
