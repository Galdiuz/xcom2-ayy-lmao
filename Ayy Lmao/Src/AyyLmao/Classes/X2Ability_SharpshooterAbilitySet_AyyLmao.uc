class X2Ability_SharpshooterAbilitySet_AyyLmao extends X2Ability_SharpshooterAbilitySet;

/*static function X2AbilityTemplate DeadeyeAbility()
{
	local X2AbilityTemplate Template;
	
	Template = Super.DeadeyeAbility();
...
static function X2AbilityTemplate ReturnFire()
{
	...
	FireEffect.SetDisplayInfo(ePerkBuff_Passive, Template.LocFlyOverText, Template.GetMyLongDescription(), Template.IconImage,,,Template.AbilitySourceName);
...
function Faceoff_BuildVisualization(XComGameState VisualizeGameState, out array<VisualizationTrack> OutVisualizationTracks)
{
	...
	if (AbilityTemplate.ActivationSpeech != '')     //  allows us to change the template without modifying this function later
	{
		...
		SoundAndFlyOver.SetSoundAndFlyOverParameters(None, AbilityTemplate.LocFlyOverText, AbilityTemplate.ActivationSpeech, eColor_Good, AbilityTemplate.IconImage);
	}
...
{		
	...
	if (AbilityTemplate.bShowActivation || AbilityTemplate.ActivationSpeech != '')
	{
		...
		{
			SoundAndFlyOver.SetSoundAndFlyOverParameters(None, AbilityTemplate.bShowActivation ? AbilityTemplate.LocFlyOverText : "", AbilityTemplate.ActivationSpeech, eColor_Good, AbilityTemplate.bShowActivation ? AbilityTemplate.IconImage : "");
		}
	}
