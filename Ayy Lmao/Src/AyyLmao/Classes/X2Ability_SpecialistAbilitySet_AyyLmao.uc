class X2Ability_SpecialistAbilitySet_AyyLmao extends X2Ability_SpecialistAbilitySet;

static function X2AbilityTemplate CombatProtocol()
{
	local X2AbilityTemplate Template;
	
	Template = Super.CombatProtocol();
...
static function X2AbilityTemplate GremlinStabilize()
{
	...
	Template = Super.GremlinStabilize();
